...
namespace App\Filament\Admin\Clusters\Settings\Resources\Roles\Pages;
...
class ViewRoleActivities extends ActivityTimelinePage
{
    ...
    // protected string $view = 'filament.admin.clusters.settings.resources.roles.pages.view-role-activities';
}
